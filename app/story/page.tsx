      ...
      <main className="flex-1">
        ...
        <section className="relative h-screen flex items-center justify-center -mt-20">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-sm sm:text-lg text-muted-foreground max-w-2xl mx-auto font-light leading-relaxed">
        ...
        <section className="py-32 px-6 sm:px-12 md:px-24">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 items-center">
            <motion.div 
              ...
              className="space-y-8"
            >
              <motion.h2 variants={fadeIn} className="font-rocaston text-2xl sm:text-4xl tracking-[0.2em] uppercase leading-tight">
            ...
            >
              ...
              <div className="absolute inset-0 bg-foreground/[0.03] backdrop-blur-2xl border border-foreground/10 rounded-3xl overflow-hidden flex flex-col items-center justify-center p-8 text-center glass">
                 ...
                 <h3 className="font-heading text-4xl uppercase text-foreground/20">Z.B.</h3>
        ...
        <section className="py-32 bg-foreground text-background">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              ...
              <motion.h2 variants={fadeIn} className="font-heading text-4xl md:text-6xl uppercase tracking-widest leading-snug">
                Zero Compromise.<br/> Maximum Impact.
              </motion.h2>
              <motion.p variants={fadeIn} className="text-background/70 leading-relaxed font-light text-sm md:text-lg max-w-2xl mx-auto">
        ...
        <section className="py-32 px-6 flex flex-col items-center justify-center text-center">
          <motion.p 
            ...
            className="font-rocaston text-2xl md:text-4xl tracking-[0.2em] uppercase mb-12"
          >
            Join The Movement.
          </motion.p>
          <motion.a 
