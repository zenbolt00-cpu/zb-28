  ...
  if (loading && products.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
        ...
        <span className="text-[10px] font-medium uppercase tracking-widest text-foreground/80 dark:text-foreground/80 dark:text-foreground/60 dark:text-foreground/80 dark:text-foreground/60 dark:text-foreground/60 dark:text-foreground/60 dark:text-foreground/40">Loading Inventory...</span>
      </div>
    );
  }
      ...
      <div className="space-y-4 relative z-10">
        {products.length === 0 ? (
          <div className="bg-background border border-foreground/[0.05] rounded-xl p-12 text-center shadow-sm">
            <PackageSearch className="w-8 h-8 text-foreground/40 dark:text-foreground/40 dark:text-foreground/40 dark:text-foreground/40 dark:text-foreground/20 mx-auto mb-4" />
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 rounded-md bg-foreground/[0.02] border border-foreground/[0.05] flex items-center justify-center shrink-0 overflow-hidden">
                    {product.image ? (
                      ...
                      <PackageSearch className="w-5 h-5 text-foreground/40 dark:text-foreground/40 dark:text-foreground/40 dark:text-foreground/40 dark:text-foreground/20" />
                    )}
                  </div>
                   <div>
                    <h3 className="text-[13px] font-semibold text-foreground tracking-tight mb-1">{product.title}</h3>
                    <div className="flex items-center gap-3 text-[9px] font-medium text-foreground/70 dark:text-foreground/70 dark:text-foreground/70 dark:text-foreground/70 dark:text-foreground/50 uppercase tracking-widest">
                            ...
                            {currentEditingSku !== undefined ? (
                              <div className="flex items-center gap-1 w-full">
                                ...
                                <button 
                                  ...
                                  className="text-foreground/80 dark:text-foreground/80 dark:text-foreground/60 dark:text-foreground/80 dark:text-foreground/60 dark:text-foreground/60 dark:text-foreground/60 dark:text-foreground/40 hover:text-foreground"
                                >
                              ...
                              <p 
                                ...
                                className="text-[9px] text-foreground/80 dark:text-foreground/80 dark:text-foreground/60 dark:text-foreground/80 dark:text-foreground/60 dark:text-foreground/60 dark:text-foreground/60 dark:text-foreground/40 font-mono cursor-edit hover:text-foreground transition-colors py-0.5"
                              >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-0.5 bg-background border border-foreground/[0.05] rounded-md p-0.5">
                            <button
                              ...
                              disabled={isLoading}
                              className="w-7 h-7 flex items-center justify-center rounded-sm text-foreground/80 dark:text-foreground/80 dark:text-foreground/80 dark:text-foreground/80 dark:text-foreground/60 hover:bg-foreground/[0.02] hover:text-foreground disabled:opacity-50 transition-colors"
                            >
