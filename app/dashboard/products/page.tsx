    ...
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
        <div className="space-y-1">
          <div className="px-2 py-0.5 bg-foreground/[0.03] rounded-md text-[7px] font-normal text-foreground/30 uppercase tracking-[0.3em] w-fit">inventory hub</div>
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center gap-2 px-5 py-2 bg-foreground/[0.03] hover:bg-foreground/[0.06] border border-foreground/[0.05] rounded-md text-[8px] font-normal uppercase tracking-[0.2em] text-foreground/40 disabled:opacity-50 transition-all active:scale-95"
        >
      ...
      <div className="flex flex-col md:flex-row gap-2">
        <div className="relative flex-1">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-foreground/10" />
          <input
            className="w-full bg-foreground/[0.02] border border-foreground/[0.05] rounded-md pl-9 pr-4 py-2 text-[10px] font-normal text-foreground placeholder:text-foreground/10 focus:outline-none focus:border-foreground/10 transition-all uppercase tracking-[0.1em]"
              ...
              >
                ...
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-1.5 text-[7px] font-normal uppercase tracking-[0.3em]">
                      {product.vendor && (
                        <span className="text-foreground/20 bg-foreground/[0.02] px-1.5 py-0.5 rounded-[2px] border border-foreground/[0.03]">
                          {product.vendor}
                        </span>
                      )}
                ...
                <div className="flex items-center gap-4 md:gap-5 shrink-0">
                  <div className="text-center">
                    <p className="text-[7px] text-foreground/10 uppercase font-normal tracking-[0.3em] mb-1 leading-none">
                      RELAY
                    </p>
                    <p
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-[7px] font-normal uppercase tracking-[0.2em] transition-all disabled:opacity-50 ${
                      product.status === "active"
                        ...
                        : "bg-foreground/[0.04] text-foreground/40 border border-foreground/[0.05]"
                    }`}
                  >
                    {isUpdating ? (
                  ...
                  <a
                    ...
                    className="p-2 bg-foreground/[0.01] border border-foreground/[0.02] rounded-lg transition-all text-muted-foreground/10 hover:text-foreground/40"
